...
PRETRAINED_DIR = os.path.join(_current_dir, 'pretrained_model', 'chinese_L-12_H-768_A-12')
DATA_DIR = os.path.join(_current_dir, 'data', 'china-people-daily-ner-corpus')
